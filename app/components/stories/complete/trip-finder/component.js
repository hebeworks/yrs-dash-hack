...
export default DatamillStory.extend({
    ...
    didInsertElement: function() {
        this.set('title', 'trip-finder TITLE');
        this.set('subTitle', 'trip-finder SUB TITLE');
        var obj = this;
        ...
        this.getData(url)
            .then(
                function(data){
                    // success
                    console.log('trip-finder > getData > success');
                ...
                function(error) {
                    // failure
                    console.log('trip-finder > getData > error: ' + error);
                },
                function(){
                    // complete
                }
